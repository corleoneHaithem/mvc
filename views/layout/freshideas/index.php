<!doctype html>  
   ...
   <link rel="stylesheet" type="text/css" href="http://localhost/mini-mvc/views/layout/freshideas/css/styles.css"/>
   </head>
   <body>
   ...
   <div id="intro">
   <img src="http://localhost/mini-mvc/views/layout/freshideas/images/banner1.png"  alt="baner">
   </div>
   <!--end intro-->
   ...
   <a class="photo_hover2" href="#"><img src="http://localhost/mini-mvc/views/layout/freshideas/images/picture2.jpg" width="150" height="99" alt="picture1"/></a>
   <h2>Lorem ipsum</h2>
   <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec molestie. Sed aliquam sem ut arcu. Phasellus sollicitudin. 
   ...
   <article class="holder_gallery">
   <a class="photo_hover2" href="#"><img src="http://localhost/mini-mvc/views/layout/freshideas/images/picture4.jpg" width="150" height="99" alt="picture1"/></a>
   <h2>Lorem ipsum</h2>
   <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec molestie. Sed aliquam sem ut arcu. Phasellus sollicitudin. 
   Vestibulum condimentum  facilisis nulla. In hac habitasse platea dictumst.
   </p> <span class="readmore"><a href="#">Read more..</a></span>
   ...
   <article class="holder_gallery">
   <a class="photo_hover2" href="#"><img src="http://localhost/mini-mvc/views/layout/freshideas/images/picture5.jpg" width="150" height="99" alt="picture1"/></a>
   <h2>Lorem ipsum</h2>
   <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec molestie. Sed aliquam sem ut arcu. Phasellus sollicitudin. 
   Vestibulum condimentum  facilisis nulla. In hac habitasse platea dictumst.
   </p> <span class="readmore"><a href="#">Read more..</a></span>
   ...
   <a class="photo_hover2" href="#"><img src="http://localhost/mini-mvc/views/layout/freshideas/images/picture3.jpg" width="257" height="295" alt="picture"/></a>   </aside>

   <section class="group3">
   <h3>About us</h3>
   <a class="photo_hover2" href="#"><img src="http://localhost/mini-mvc/views/layout/freshideas/images/picture1.jpg" width="200" height="97" alt="picture1"/></a>
